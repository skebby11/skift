...
enum WorldPalette {
    ...
    static let cypress = NSColor(red: 0.12, green: 0.24, blue: 0.18, alpha: 1)
    static let olive = NSColor(red: 0.40, green: 0.48, blue: 0.30, alpha: 1)
    static let bushLight = NSColor(red: 0.31, green: 0.41, blue: 0.22, alpha: 1)
    static let agave = NSColor(red: 0.28, green: 0.43, blue: 0.39, alpha: 1)
    static let vine = NSColor(red: 0.27, green: 0.40, blue: 0.19, alpha: 1)
    static let flowerRed = NSColor(red: 0.69, green: 0.23, blue: 0.15, alpha: 1)
    static let flowerOchre = NSColor(red: 0.76, green: 0.52, blue: 0.18, alpha: 1)
    static let post = NSColor(red: 0.35, green: 0.31, blue: 0.25, alpha: 1)
